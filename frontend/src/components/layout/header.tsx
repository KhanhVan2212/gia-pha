...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-40 flex h-16 lg:h-20 items-center justify-between border-b border-slate-100 dark:border-slate-800 bg-white/70 dark:bg-slate-950/70 backdrop-blur-md px-4 lg:px-8 transition-all">
      {/* --- Left side --- */}
        ...
        {isLoggedIn ? (
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" className="h-9 lg:h-11 px-1.5 lg:px-2 rounded-2xl hover:bg-slate-100 dark:hover:bg-slate-800 transition-all flex items-center gap-2">
            ...
            <DropdownMenuContent className="w-64 mt-2 p-2 rounded-[20px] shadow-2xl bg-white dark:bg-slate-900 border-slate-100 dark:border-slate-800 animate-in slide-in-from-top-2" align="end">
